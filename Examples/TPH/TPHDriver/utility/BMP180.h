...
#define BMP180_ADDR 0xEE // BMP180 Addr for read 8-bit address
...
class BMP180
{
	public:
		...
		static double getPressure(double T);
		...
		static double sealevel(double P, double A);
