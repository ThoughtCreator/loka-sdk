...
| sendGPSPosition(float latitude, float longitude, float speed)                             | Sends GPS Position over Sigfox                          | int sendGPSPosition(float latitude, float longitude, float speed)                                    | latitude, longitude: The GPS coordinates speed: The current speed. timestamp.                                                                             | 1 if Success. 0 if error.                                                                       |
...
| getDefaultMode()                                                                          | Get sigfox Firmware default file                        | static int getDefaultMode()                                                                          | None                                                                                                                                                      |  RCZ1 = 0, RCZ2 = 1, RCZ3 = 2, RCZ4 = 3                                     |
